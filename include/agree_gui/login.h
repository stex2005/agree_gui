...
struct dati {
    ...
    static int16_t status1, command_pp,command_old_pp,command_login,  command_matrix, command_old_login,  command_old_matrix, command_old_sc3, command_sc3, flag_sc3;
};
