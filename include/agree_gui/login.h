...
struct dati {
    ...
    static int8_t status1, command_login, command_pp, command_matrix, command_old_login, command_old_pp, command_old_matrix, command_exercise_pp, command_task_pp, command_exercise_old_pp, command_task_old_pp, flag_ex;
};
